...
ent-BorgDisguise = Сменить маскировку
    .desc = Переключиться между различными маскировками киборга для маскировки.
ent-BorgStealth = Переключить скрытность
    .desc = Активировать или деактивировать устройство маскировки для невидимости.
