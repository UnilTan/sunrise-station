...
ent-ClothingOuterHardsuitPirateEVASun = скафандр EVA для глубоко космоса
...
ent-ClothingOuterHardsuitInfiltration = бронекостюм Синдиката: Проникновение
    .desc = Бронекостюм, предпочитаемый Специальными Операциями Синдиката. Он, помимо прочности, был разработан с учетом скрытности.
