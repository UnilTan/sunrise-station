...
ent-MindRoleGhostRoleFreeAgent = роль призрака (Свободный агент)
    .desc = { ent-BaseMindRole.desc }
ent-MindRoleGhostRoleFreeAgentHarmless = роль призрака (Безобидный Свободный Агент)
...
ent-MindRoleGhostRoleTeamAntagonist = роль призрака (Командный антагонист)
    .desc = { ent-BaseMindRole.desc }
ent-MindRoleGhostRoleTeamAntagonistFlock = роль призрака (Командный антагонист Стаи)
