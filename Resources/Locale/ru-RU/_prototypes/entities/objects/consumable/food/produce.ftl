...
ent-FoodExtradimensionalOrange = внезмерный апельсин
    .desc = Трудно осмыслить этот фрукт.
...
ent-FoodRealCapfruit = капфрут
    .desc = Мягкий, но гладкий фрукт в форме оружия.
...
ent-FoodKoibean = коибобы
    .desc = Эти бобы кажутся немного подозрыбными.
...
ent-FoodWorldPeas = мировой горох
    .desc = По слухам, тот, кто его съест, обретёт мир в душе.
...
ent-FoodBloonion = луковица блуниона
    .desc = Странная парящая луковица... Не стоит из-за неё плакать.
