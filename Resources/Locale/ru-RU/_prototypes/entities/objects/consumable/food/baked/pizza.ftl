...
ent-FoodPizzaCottonSlice = кусок пиццы из хлопка
    .desc = Кусок хлопковой пиццы. Хлопок включён.
ent-FoodPizzaWorldpeas = Пицца Мира
    .desc = Современная дипломатия в форме диска.
ent-FoodPizzaWorldpeasSlice = ломтик Пиццы Мира
    .desc = Разделение мира — небольшая цена за гармонию.
