...
ent-EncryptionKeyBinarySyndicate = двоичный ключ транслирования
    .desc = Ключ шифрования синдиката, который позволяет переводить двоичные сигналы, используемые роботами.
