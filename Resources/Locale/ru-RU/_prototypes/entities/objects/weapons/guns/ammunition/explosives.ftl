...
ent-GrenadeBlastContact = контактная взрывная граната
    .desc = { ent-BaseGrenade.desc }
ent-GrenadeFlashContact = контактная светошумовая граната
    .desc = { ent-BaseGrenade.desc }
ent-GrenadeFragContact = контактная осколочная граната
    .desc = { ent-BaseGrenade.desc }
ent-GrenadeCleanade = граната с очищающим газом
    .desc = { ent-BaseGrenade.desc }
ent-GrenadeEMPContact = контактная ЭМИ граната
    .desc = { ent-BaseGrenade.desc }
