...
signal-port-name-set-target = Установить цель
signal-port-description-set-target = Устанавливает целевой сигнал для сравнения в WiFi компонентах.

# Компонент силового реле
signal-port-name-set-state = Установить состояние
signal-port-description-set-state = Напрямую устанавливает состояние реле (1 = активно, другое = неактивно).

signal-port-name-signal-input-a = Сигнальный вход A
signal-port-description-signal-input-a = Первый сигнальный вход, который будет направлен на выход A когда реле активно.

signal-port-name-signal-input-b = Сигнальный вход B
signal-port-description-signal-input-b = Второй сигнальный вход, который будет направлен на выход B когда реле активно.
