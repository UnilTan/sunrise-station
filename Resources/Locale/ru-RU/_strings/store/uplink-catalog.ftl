...
uplink-grenade-launcher-china-lake-name = Гранатомет China-Lake
...
uplink-gorilla-upgrade-kit-desc = Вставьте этот чип в стандартную перчатку Г.О.Р.И.Л.Л.А. или в модуль протеза, чтобы разблокировать встроенные безопастные ограничители и высвободить 100% мощи.
