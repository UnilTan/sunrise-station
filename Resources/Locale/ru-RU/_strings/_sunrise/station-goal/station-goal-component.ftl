...
station-goal-shuttle =
    ...
    ⠀​[italic]Центральное Командование дополнительно уведомляет о возможном наличии на объекте сотрудника Центрального Командования — Представителя NanoTrasen и уполномоченно сотрудника Департамента внутреннего надзора — Агента Внутренних Дел. Мы требуем полного содействия данным лицам во всех вопросах.[/italic]
    ⠀⠀
...
station-goal-delta-ambusol =
    [bold]Форма NT/КОМ-ЦК-СИТ-ОМЕГА[/bold]
    ⠀​[head=3]Приказ Центрального Командования[/head]
...
station-goal-reports =
    ...
    ⠀Все отчеты передать Представителю NanoTrasen. На выполнение дается 2 часа.
