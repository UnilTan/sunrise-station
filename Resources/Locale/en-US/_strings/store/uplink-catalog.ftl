...
uplink-nukeops-comm-jammer-name = Communications Jammer
uplink-nukeops-comm-jammer-desc = A powerful station-wide jammer that blocks all radio communications, fax transmissions, announcements, and emergency response calls when deployed and powered. Must be placed on the target station to function.
...
uplink-emp-implanter-desc = Detonates a small EMP pulse on activation that drains nearby electronics of their power, can be used three times, after which it will require recharging.
