supermatter-examine-integrity = It's integrity is { $integrity }%
supermatter-announcement-sender = Automatic Supermatter Engine
...
supermatter-announcement-delam-countdown = Estimated time until delamination: { $seconds } seconds.
supermatter-announcement-delam-explosion = Engaging casualty destabilization field.
...
supermatter-tamper-fail = Кристалл слишком поврежден, чтобы извлечь из него еще осколки.
supermatter-announcement-tamper = Внимание! Обнаружено несанкционированное вмешательство в кристалл суперматерии! Целостность: { $integrity }%
