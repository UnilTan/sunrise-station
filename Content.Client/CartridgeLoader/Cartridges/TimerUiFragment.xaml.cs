...
public sealed partial class TimerUiFragment : BoxContainer
{
    ...
    public TimerUiFragment()
    {
        ...
        MinutesInput.OnFocusEntered += _ => { if (MinutesInput.Text == MinutesInput.PlaceholderText) MinutesInput.Text = ""; };
        SecondsInput.OnFocusEntered += _ => { if (SecondsInput.Text == SecondsInput.PlaceholderText) SecondsInput.Text = ""; };
