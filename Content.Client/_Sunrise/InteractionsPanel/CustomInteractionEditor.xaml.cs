...
public sealed partial class CustomInteractionEditor : DefaultWindow
{
    ...
    private void UpdateEffectControlsEnabled()
    {
        ...
        EffectChanceLabel.Modulate = enabled ? Color.White : Color.Gray;
    }
    ...
    private void OnSavePressed(BaseButton.ButtonEventArgs args)
    {
        ...
        _interaction.Name = NameInput.Text;
        _interaction.Description = DescriptionInput.Text;
    ...
    private void ShowError(string message)
    {
        ...
        var errorLabel = new Label
        {
            ...
            FontColorOverride = new Color(255, 200, 200)
        };
