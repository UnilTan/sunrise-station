...
public sealed class RadioSystem : EntitySystem
{
    ...
    /// </summary>
    public void SendRadioMessage(EntityUid messageSource, string message, ProtoId<RadioChannelPrototype> channel, EntityUid radioSource, bool escapeMarkup = true, bool playTts = true)
    {
        SendRadioMessage(messageSource, message, _prototype.Index(channel), radioSource, escapeMarkup: escapeMarkup, playTts: playTts);
    }
    ...
    public void SendRadioMessage(EntityUid messageSource, string message, RadioChannelPrototype channel, EntityUid radioSource, bool escapeMarkup = true, bool playTts = true)
    {
        ...
        if (playTts) // Sunrise-TTS: this event is used only to play tts
