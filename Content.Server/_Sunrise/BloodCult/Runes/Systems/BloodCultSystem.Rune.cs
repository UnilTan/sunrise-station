...
namespace Content.Server._Sunrise.BloodCult.Runes.Systems
{
    public partial class BloodCultSystem
    {
        ...
        private void SpawnRune(EntityUid uid, string? rune)
        {
            ...
            // Store creator's DNA in ForensicsComponent for security analysis  
            ...
            // Add blood solution to the rune's puddle
            if (TryComp<BloodstreamComponent>(uid, out var bloodstreamComponent) && 
                TryComp<PuddleComponent>(runeEntity, out var puddleComp))
            {
